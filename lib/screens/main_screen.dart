...
class MainScreenState extends State<MainScreen> {
  ...
  List<Student> students = [
    ...
    risk_level: 'High, Immediate medical attention is recommended.', urgent_action: 'Seek immediate consultation with a cardiologist for further evaluation and treatment.', whatThisMeans: 'You are having an acute MI. Consult cardiologist asap.')
  ];
